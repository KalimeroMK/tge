<div class="form-group has-feedback row">
    ...
    <div class="col-md-9">
        <div class="input-group">
            <select class="<?php echo e($errors->has('typeId') ? 'custom-select form-control is-invalid ' : 'custom-select form-control'); ?>"
                ...
                <?php if($blockedTypes): ?>
                    <?php $__currentLoopData = $blockedTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blockedType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($blockedType->id); ?>"
                                data-type="<?php echo e($blockedType->slug); ?>" <?php if(isset($item)): ?> <?php echo e($item->typeId == $blockedType->id ? 'selected="selected"' : ''); ?> <?php endif; ?> >
...
<?php /**PATH /var/www/html/resources/views/vendor/laravelblocker/forms/partials/item-type-select.blade.php ENDPATH**/ ?>