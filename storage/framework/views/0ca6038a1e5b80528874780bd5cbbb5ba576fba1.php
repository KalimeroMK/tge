<div class="form-group has-feedback row">
    ...
    <div class="col-md-9">
        <div class="input-group">
            <select class="<?php echo e($errors->has('userId') ? 'custom-select form-control is-invalid disabled' : 'custom-select form-control disabled'); ?>"
                ...
                <?php if($users): ?>
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($aUser->id); ?>"
                                data-email="<?php echo e($aUser->email); ?>" <?php if(isset($item->userId)): ?> <?php echo e($item->userId == $aUser->id ? 'selected="selected"' : ''); ?> <?php endif; ?> >
...
<?php /**PATH /var/www/html/resources/views/vendor/laravelblocker/forms/partials/item-blocked-user-select.blade.php ENDPATH**/ ?>