...
<meta itemprop="name" content="<?php echo e($story->title); ?>">
<meta itemprop="description" content="<?php echo \Illuminate\Support\Str::limit(strip_tags($story->description), 300, '...'); ?>">
<meta itemprop="image" content="http://tge.mk/assets/img/products/medium/<?php echo e($story->image); ?>">
<!-- Twitter Card data -->
<meta name="twitter:card" content="http://tge.mk/assets/img/products/medium/<?php echo e($story->image); ?>">
<meta name="twitter:site" content="@zaebalovek">
<meta name="twitter:title" content="<?php echo e($story->title); ?>">
<meta name="twitter:description" content="<?php echo \Illuminate\Support\Str::limit(strip_tags($story->description), 300, '...'); ?>">
<meta name="twitter:creator" content="@zaebalovek">
<meta name="twitter:image" content="http://tge.mk/assets/img/products/medium/<?php echo e($story->image); ?>">
<!-- Open Graph data -->
<meta property="fb:app_id" content="1192823797520220"/>
<meta property="og:type" content="article"/>
<meta property="og:url" content="http://tge.mk//product/<?php echo e($story->slug); ?>"/>
<meta property="og:title" content="<?php echo e($story->title); ?>"/>
<meta property="og:image" content="http://tge.mk/assets/img/products/medium/<?php echo e($story->image); ?>"/>
<meta property="og:description" content="<?php echo \Illuminate\Support\Str::limit(strip_tags($story->description), 300, '...'); ?>"/>
                        ...
                        <div class="col-lg-12">
                                    ...
                                    <div class="carousel-inner">
                                        <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="item <?php echo e($key == 0 ? 'active' : ''); ?>">
                                                ...
                                                <img src="/assets/img/sliders/<?php echo e($slider->imagethumb); ?>" alt="image"
                            ...
                            <div class="gellarypostCont">
                                <h2 class="blogtitle gellary">
                                    <a href="#"><?php echo e($story->title); ?></a>
                                </h2>
                                <p> <?php echo $story->description; ?></p>

                            </div>
                            <div class="blogMeta gfullwidth">
                                <a href="#"><i class="fa fa-user"></i><?php echo e($story->user->name); ?></a>
                                <a href="#"> <i class="fa fa-clock-o"></i><?php echo e($story->created_at); ?></a>
                                <div class="social-icons-article pull-right">
                                    ...
                                    <a href="https://twitter.com/intent/tweet?url=<?php echo e(URL::current()); ?>&text=<?php echo e($story->title); ?>"
                                    ...
                                    <a href="https://www.linkedin.com/shareArticle?url=<?php echo e(URL::current()); ?>&title=<?php echo e($story->title); ?>"
                                    ...
                                    <a href="https://reddit.com/submit?url=<?php echo e(URL::current()); ?>&title=<?php echo e($story->title); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/main/story.blade.php ENDPATH**/ ?>