     ...
     public function generateFeed()
     {
         ...
         if ($this->version == JSON || $this->version == JSONP) {
             if (!$this->simplejson) {
                 ...
                 if (isset($jsonitem->title)) {
                     $simplejson->title = $jsonitem->title;
                 }
                 if (isset($jsonitem->dc_language)) {
                     $simplejson->language = $jsonitem->dc_language;
                 }
                 ...
                 if (isset($jsonitem->og_url)) {
                     $simplejson->og_url = $jsonitem->og_url;
                 }
                 if (isset($jsonitem->og_title)) {
                     $simplejson->og_title = $jsonitem->og_title;
                 }
                 if (isset($jsonitem->og_description)) {
                     $simplejson->og_description = $jsonitem->og_description;
                 }
                 if (isset($jsonitem->og_image)) {
                     $simplejson->og_image = $jsonitem->og_image;
                 }
                 if (isset($jsonitem->og_type)) {
                     $simplejson->og_type = $jsonitem->og_type;
                 }
                 if (isset($jsonitem->twitter_card)) {
                     $simplejson->twitter_card = $jsonitem->twitter_card;
                 }
                 if (isset($jsonitem->twitter_site)) {
                     $simplejson->twitter_site = $jsonitem->twitter_site;
                 }
                 if (isset($jsonitem->twitter_creator)) {
                     $simplejson->twitter_creator = $jsonitem->twitter_creator;
                 }
                 if (isset($jsonitem->twitter_image)) {
                     $simplejson->twitter_image = $jsonitem->twitter_image;
                 }
                 if (isset($jsonitem->twitter_title)) {
                     $simplejson->twitter_title = $jsonitem->twitter_title;
                 }
                 if (isset($jsonitem->twitter_description)) {
                     $simplejson->twitter_description = $jsonitem->twitter_description;
                 }
     ...
     */
     private function printHead()
     {
         if ($this->version == RSS2) {
             ...
             if ($this->xsl) {
                 $out .= '<?xml-stylesheet type="text/xsl" href="'.htmlspecialchars($this->xsl).'"?>' . PHP_EOL;
             }
             ...
             foreach ($itemElements as $thisElement) {
                 foreach ($thisElement as $instance) {
                     if ($this->version == RSS2) {
                         ...
                         if (preg_match('/^(twitter|og):/i', $instance['name'])) {
                             continue;
                         }
